      ...
      <div className={styles.aboutBox}>
        <div className={styles.aboutMe}>
          ...
          <p className={styles.intro}>
            I was born and raised in Chau Doc, a small town located on the
            Mekong Delta in the South of Vietnam, where you can spot countless
            floating houses, tons of motorbikes on streets and endless green
            rice fields. I came to the US in 2015 and graduated Summa Cum Laude
            with an Associate’s degree in Cybersecurity in 2018. Right after
            finishing college, I attended a coding bootcamp at Flatiron School
            to learn full stack web development. I completed the bootcamp in
            April 2019 and have been working professionally as a software
            engineer since then. So far, I have contributed to two major
            projects (one for the Washington DC Government, one for the Federal
            Government) and other projects. I am a lifelong learner who is
            always looking to acquire new techinial expertise to keep myself up
            to date with the nonstop evolving development industry and to add
            more value to my products.
          </p>
        </div>
      </div>
